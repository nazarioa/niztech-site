...
const DIST_APPLE_ASSOCIATION_PATH = [
  DIST_WELL_KNOWN_PATH,
  DIST_APPLE_ASSOCIATION_FILE,
].join('/');
const RESOURCE_APPLE_ASSOCIATION_PATH = [
  RESOURCES_PATH,
  RESOURCE_APPLE_ASSOCIATION_FILE,
].join('/');
...
[
  {
    source: RESOURCE_APPLE_ASSOCIATION_PATH,
    destination: DIST_APPLE_ASSOCIATION_PATH,
  },
